...
By default, Jesture copies a configuration file to your {RAILS_ROOT}/config directory.  All combos and jestures
in this file are commented out, so it will not affect your application.
